...
public interface Marathon {
	...
	@Headers(HeaderUtils.MARATHON_API_SOURCE_HEADER)
	AppWithVersion createApp(App app) throws MarathonException;
	...
	@Headers(HeaderUtils.MARATHON_API_SOURCE_HEADER)
	AppWithVersion getApp(@Param("id") String id, @Param("version") String version);
	...
	@Headers(HeaderUtils.MARATHON_API_SOURCE_HEADER)
	GetEventSubscriptionRegisterResponse register(@Param("url") String url) throws MarathonException;

	@RequestLine("DELETE /v2/eventSubscriptions?callbackUrl={url}")
	@Headers(HeaderUtils.MARATHON_API_SOURCE_HEADER)
	GetEventSubscriptionRegisterResponse unregister(@Param("url") String url) throws MarathonException;
